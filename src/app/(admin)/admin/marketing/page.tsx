  ...
  return (
    <div className="space-y-8 text-left">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white">Marketing, Catalog & Follow-Up Assistant</h1>
          <p className="text-slate-500 text-xs mt-1">Chat with the AI to draft marketing copy, follow up on real leads, or create/edit catalog products and generate product images — review before sending.</p>
        </div>
        {dueCount > 0 && (
