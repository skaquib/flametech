...
${form.message}`;
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      details: "info@flametechengineering.com",
      desc: "Send formal RFP specifications, quotation forms, or purchase orders (PO).",
    },
    {
      icon: <Mail className="w-5 h-5 text-brand-orange" />,
      title: "Technical Support Email",
      details: "support@flametechengineering.com",
      desc: "Log breakdown complaints, AMC service issues, or spare part defect claims.",
    },
    {
